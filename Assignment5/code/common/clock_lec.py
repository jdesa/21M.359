...
class TempoMap1(object):
   def __init__(self, data):
      super(TempoMap1, self).__init__()
...
class Conductor(object):
   ...
   # if tempo_map is enabled, Conductor uses tempo_map instead of bpm.
   ...
   def get_bpm(self) :
      if self.tempo_map:
         # TODO - implement by asking tempo_map the current tempo
         return 0
      else:
         return self.bpm
...
# Manages calling functions at a future tick.
...
# A function to be called at a particular tick, packaged as an object.
