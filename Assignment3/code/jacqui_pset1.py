...
class MainWidget(BaseWidget):
   ...
   def on_key_down(self, keycode, modifiers):
      ...
      scaledegrees = ['1','2','3','4','5','6','7','8','9']
      #Setting changed keys as Sharp or Flat
      if keycode[1] == '[':
         self.keymodifier = "flat"
      elif keycode[1] == ']':
         self.keymodifier = "sharp"
      if keycode[1] in scaledegrees: #valid scale degrees -- in base 1
         self.audio.add_generator(NoteGenerator((self.audio.rootpitch + majorkeyintervals[int(keycode[1])-1]), self.audio.wavetype))
      #Changing key
